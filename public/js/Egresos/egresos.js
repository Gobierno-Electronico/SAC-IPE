...
function generarPolizaRemanente(btn, liberado) {
  ...
  console.log($('#botonRemanente').val())
    const wsUrl = "http://"+IP_PORT+"/"+NOMBRE_REPORTEADOR+"/webresources/service/report?name=PolizaEgresosRemanente&params="
...
function generarPolizaRemanenteLiberado(btn){
    ...
    const wsUrl = "http://"+IP_PORT+"/"+NOMBRE_REPORTEADOR+"/webresources/service/report?name=PolizaEgresosRemanenteLiberado&params="
