                    ...
                    <div class="card-body bg-white p-5">
                        ...
                        <form method="POST" action="{{ route('cambiosUsuario') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ Session::get('usuario')->nombre }}" required autocomplete="nombre" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="apellido_paterno" type="text" class="form-control @error('apellido_paterno') is-invalid @enderror" name="apellido_paterno" value="{{ Session::get('usuario')->apellido_paterno }}" required autocomplete="apellido_paterno" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="apellido_materno" type="text" class="form-control @error('apellido_materno') is-invalid @enderror" name="apellido_materno" value="{{ Session::get('usuario')->apellido_materno }}" required autocomplete="apellido_materno" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="usuario" type="text" class="form-control @error('usuario') is-invalid @enderror" name="usuario" value="{{ Session::get('usuario')->usuario }}" required autocomplete="usuario" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select name="rol" id="rol" class="form-control @error('rol') is-invalid @enderror" name="rol" required>
                                        <option value="" disabled>{{ __('Selecciona un cargo') }}</option>
                                        @foreach (App\Enums\RolEnum::valores() as $key => $value)
                                            <option value="{{ $key }}" @if (Session::get('usuario')->rol->value == $key) selected @endif>{{ $key }}</option>
                                        @endforeach
                                    </select>
                                    @error('rol')
                                        <script>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="numero_de_personal" type="number" min="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control @error('numero_de_personal') is-invalid @enderror" name="numero_de_personal" value="{{ Session::get('usuario')->numero_de_personal }}" required autocomplete="numero_de_personal">
