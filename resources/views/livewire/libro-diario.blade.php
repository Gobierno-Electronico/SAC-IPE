    ...
    <div class="pb-4 pt-3 h-auto">
        <div class="pb-4 pt-3 h-auto">
            <div class="d-flex flex-row">
                <select class="rounded-1 shadow-sm border-0 w-25 me-3 select_presupuesto rounded-1 shadow-sm border-0" name="Anio" id="Anio"
                ...
                <input type="date" id="fecha1" name="fecha1" class=" rounded-1 shadow-sm border-0 w-25 me-3 p-1"  wire:model.live="fecha1" value="" >
                <input type="date" id="fecha2" name="fecha2" class=" rounded-1 shadow-sm border-0 w-25 me-3 p-1"  wire:model.live="fecha2" value="" >
            </div>
        </div>
    </div>
...
<script>
    window.addEventListener('descargar', event => {
        let btnId = "botonGenerarLibroDiario"
        ...
        let url = "http://10.0.2.59:8080/Reporteador/webresources/service/report?name=LibroDiario&params="
