<div>
    ...
    <x-modal value="validarPolizaInicial" mensajeBoton="Confirmar" accion="validarPolizaInicial()"
        titulo="Confirmar acción">
        ¿Está seguro(a) que todos los registros de la póliza inicial SON CORRECTOS?
        Una vez que se validen no podrá ser revertido.
    </x-modal>

    <x-modal value="borrarPolizaInicial" mensajeBoton="Confirmar" accion="borrar()" titulo="Confirmar acción">
        ¿Está seguro(a) que deseas borrar la póliza inicial?
    ...
    <div class="mt-4 d-flex justify-content-between">
        <button @if ($validado) disabled @endif id="borrarPresupuesto" type="button"
            ...
            data-bs-target="#confirmModalborrarPolizaInicial">
            Borrar póliza inicial
        </button>
        <div>
