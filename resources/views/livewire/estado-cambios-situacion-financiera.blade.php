<div>
    ...
    <div class="mt-4 d-flex flex-row-reverse">
            <button id="botonGenerarEstadoSituacionFinanciera" wire:click="generar('PDF')" type="button"
                ...
                Generar Estado de Cambios en la Situación Financiera PDF
            </button>
             ...
             <button id="botonGenerarEstadoSituacionFinanciera" wire:click="generar('X')" type="button"
                ...
                Generar Estado de Cambios en la Situación Financiera EXCEL
            </button>
    </div>
</div>
<script>
    window.addEventListener('descargar', event => {
        ...
        let url = "http://" + window.IP_PORT + "/" + window.window.NOMBRE_REPORTEADOR + "/webresources/service/report?name=ReporteEstadoCambiosSituacionFinanciera&params=" 
