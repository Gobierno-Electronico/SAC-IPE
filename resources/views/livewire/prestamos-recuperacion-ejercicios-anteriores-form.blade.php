<div class="mt-5">
    @if ($consultarRegistro)
        ...
        <livewire:prestamos-form-consulta-table :$numeroPoliza :$numeroEvento :$total
            tipoMovimiento="PolizaRecuperacionEjerciciosAnteriores"
            urlFinalizar="/capitulo7-recuperacion-ejercicios-anteriores" tipoPoliza="D"
            categoriaModulo='RECUPERACION EJERCICIOS ANTERIORES' />
    @else
        ...
        <div class="row">
            <div class="col-3">
                ...
                <label for="selectCuentaCargo" class="form-label mt-3">Cuenta cargo</label>
                <select name="selectCuentaCargo" id="selectCuentaCargo" class="form-select" wire:model="cuentaCargo">
                    <option value="" disabled selected>Seleccionar cuenta cargo</option>
            ...
            <div class="col">
                <livewire:prestamos-recuperacion-ejercicios-anteriores-table />
            </div>
