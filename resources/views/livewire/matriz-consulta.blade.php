<div class="d-flex flex-column gap-3">
    ...
    <div class="col-5 mb-4">
        ...
        <select name="inputCategoriaMatriz" id="inputCategoriaMatriz" class="form-select" wire:model.live="tipoMatriz">
            ...
            <option value="INGRESOS RECAUDADO PREVIAMENTE REGISTRADOS POR CLASIFICAR">Ingresos recaudado por clasificar</option>
                            ...
                            <div class="py-2 px-3 d-flex align-items-center">
                                ...
                                @if($sortBy === $column->key)
                                    @if($sortDirection === 'asc')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="flecha_orden" viewBox="0 0 20 20" fill="currentColor">
