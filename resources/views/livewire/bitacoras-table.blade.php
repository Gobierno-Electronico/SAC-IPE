<div>
    ...
    <div class="pb-4 pt-3 h-auto">
        <div class="d-flex flex-row">
            ...
            <input type="date" id="fecha" name="fecha" class="input_busqueda rounded-1 shadow-sm border-0 w-25 me-3"  wire:model.live="fecha" value="" placeholder="Buscar por fecha...">
        </div>
    </div>
