...
<script>
    window.addEventListener('descargar', event => {
        let btnId = "botonGenerarEstadoActividades"
        ...
        let url = "http://" + window.IP_PORT + "/" + window.window.NOMBRE_REPORTEADOR + "/webresources/service/report?name=ReporteEstadoActividades&params=" 
