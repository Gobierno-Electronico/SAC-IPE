<div class="mt-5">
    @if ($consultarRegistro)
        ...
        <livewire:egresos-form-consulta-table :$numeroPoliza :$numeroEvento :$total
            tipoMovimiento="PolizaEgresosComprometidoCapitulo4" urlFinalizar="/capitulo4-comprometido" tipoPoliza="E"
            categoriaModulo='EGRESOS COMPROMETIDO CAPITULO 4' />
    @else
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:egresos-capitulo4-comprometido-table />
            </div>
