<div class="mt-5">
    @if ($consultarRegistro)
        ...
        <livewire:prestamos.prestamos-form-consulta-table :$numeroPoliza :$numeroEvento :$total
            tipoMovimiento="PolizaRecuperacionRecaudadoPrestamosRenovacion"
            urlFinalizar="/capitulo7-recuperacion-recaudado-prestamosRenovacion" tipoPoliza="D"
            categoriaModulo='RECUPERACION RECAUDADO PRESTAMOS RENOVACION' />
    @else
        ...
        <div class="row">
            ...
            <div class="col">
                <livewire:prestamos.prestamos-recuperacion-recaudado-prestamosRenovacion-table />
            </div>
