     ...
     @else
         ...
         <div class="row">
             <div class="col-3">
                 ...
                 <select name="selectDocumentoFuente" id="selectDocumentoFuente" class="form-select" wire:model="documentoFuente">
                 ...
                 <input type="text" name="inputImporte" id="inputImporte" class="form-control"
                     onkeyup="validarDecimales(this)" onchange="formatearImporte(this)" wire:model.live="importe"
