<div class="mt-5">
    ...
    <livewire:ingresos-form-consulta-table :$numeroPoliza :$numeroEvento :$total tipoMovimiento="PolizaIngresosDevengado" urlFinalizar="/ingresos-devengado" tipoPoliza="I" />
@else
    ...
    <div class="row">
        <div class="col-3">
            ...
            <input type="text" name="inputPTTOEjecutar" id="inputPTTOEjecutar" class="form-control"
                disabled>
