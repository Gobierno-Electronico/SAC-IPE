<div class="mt-5">
    ...
    <livewire:ingresos-form-consulta-table :$numeroPoliza :$numeroEvento :$total tipoMovimiento="PolizaIngresosAutorizacionDevolucion" urlFinalizar="/autorizacion-devolucion" tipoPoliza="I" />
@else
    ...
    <div class="row">
        <div class="col-3">
            ...
            <input type="text" name="inputIva" id="inputIva" class="form-control" disabled wire:model.live="causaIva">

            <label for="selectMes" class="form-label mt-3">Mes de afectación</label>
            <select name="selectMes" id="selectMes" class="form-select" wire:model.live="mes" wire:change="cambioPresupuesto">
            ...
            <input type="text" name="inputPTODevengado" id="inputPTODevengado" class="form-control"
                disabled>
...
<script>
    ...
    window.addEventListener('llenarFormulario', event => {
        ...
        formatearImporte({id: 'inputPTODevengado'})
    });
</script>
