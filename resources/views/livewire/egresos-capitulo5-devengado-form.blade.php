<div class="mt-5">
    @if ($consultarRegistro)
        ...
        <livewire:egresos-form-consulta-table :$numeroPoliza :$numeroEvento :$total :$numeroPolizaRemanente
            ...
            categoriaRemanente='EGRESOS COMPROMETIDO CAPITULO 5 REMANENTE DEVENGADO' />
    @else
        ...
        <div class="row">
            <div class="col-3">
                ...
                <label>
                    <input type="radio" name="selectorPagoRetenciones" wire:model.live="selectorPagoRetenciones"
                        wire:change="llenarCuentasContableAbono" value="SI">
                    Sí
                </label>
                &nbsp;&nbsp;&nbsp;
                <label>
            ...
            <div class="col">
                <livewire:egresos-capitulo5-devengado-table />
            </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col text-end">
                    <button class="btn btn_primario" wire:click="finalizarRegistro">Finalizar registros</button>
                </div>
            </div>
        </div>
    @endif
