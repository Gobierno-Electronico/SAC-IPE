                        ...
                        <div class="col text-end">
                            <div class="col">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1.8em" data-toggle="tooltip"
                                    ...
                                    title="Seleccione primero el capítulo que se va a cargar. Posteriormente, seleccione el archivo Excel para iniciar la carga del presupuesto inicial."
                                    viewBox="0 0 512 512">
                                    <style>
                                        svg {
                                            fill: #198754
                ...
                <div class="mt-5">
                    <select class="select_presupuesto rounded-1 shadow-sm border-0 w-25" name="capitulo" id="capitulo"
                        ...
                        @php
                            $capitulo = 1000;
                        @endphp
                        <option selected disabled>Seleccione el capítulo a cargar</option>
