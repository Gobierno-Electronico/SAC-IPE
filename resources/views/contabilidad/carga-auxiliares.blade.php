...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow border-0 p-5">
                        ...
                        <div class="col text-end">
                            <div class="col">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1.8em" data-toggle="tooltip"
                                    ...
                                    title="Seleccione primero el año. Posteriormente, seleccione el archivo Excel para iniciar la carga de auxiliares."
                                    viewBox="0 0 512 512">
                                    <style>
                                        svg {
                                            fill: #198754
            ...
            <form id="formImportarAuxiliares" action="/contabilidad/cargar-auxiliares" method="post"
                enctype="multipart/form-data">
                @csrf

                <div class="mt-3">
                    <select class="select_presupuesto rounded-1 shadow-sm border-0 w-25" name="anio" id="anio"
