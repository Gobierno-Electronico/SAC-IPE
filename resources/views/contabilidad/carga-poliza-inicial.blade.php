@extends('layouts.app')
@section('titulo', 'Carga póliza inicial')

@section('content')
    <script src="{{ asset('js/Contabilidad/cargarPolizaInicial.js') }}"></script>
    <x-download />
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow border-0 p-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="">
                    <div class="d-flex flex-row">
                        <h2 class="">
                            Carga de póliza inicial
                        </h2>
                        <div class="col text-end">
                            <div class="col">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1.8em" data-toggle="tooltip"
                                    data-bs-placement="left"
                                    title="Seleccione el archivo Excel para iniciar la carga de la póliza inicial."
                                    viewBox="0 0 512 512">
                                    <style>
                                        svg {
                                            fill: #198754
            ...
            <form id="formCargarPolizaInicial" action="{{route('cargarPolizaInicial')}}" method="post"
