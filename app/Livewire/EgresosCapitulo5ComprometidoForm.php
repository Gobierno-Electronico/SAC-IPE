...
class EgresosCapitulo5ComprometidoForm extends Component
{
    ...
    public function render() 
    {
        try{
            ...
            ->whereIn('interaccion_cuenta_conceptos.concepto_id', [65, 66, 67])->where('interaccion_cuenta_conceptos.tipo_interaccion', '=', 'Presupuestal - Cargo')
            ->orderBy('cuentas.Codigo_cuenta')->get();

            return view('livewire.egresos-capitulo5-comprometido-form', ['cuentas' => $cuentas]);
        }catch(\Throwable $th){
            Log::error('Ocurrió un error al cargar cuentas en comprometido del capítulo 5: ' . $th->getMessage());
    ...
    public function cambioPresupuesto()
    {
        try{
            ...
            Log::error('Ocurrió un error al cargar presupuesto en comprometido del capítulo 5: ' . $th->getMessage());
   ...
   public function agregarRegistro()
    {
        try{
           ...
           // $this->limpiar(); 
            ...
            Log::error('Ocurrió un error al agregar registro en comprometido del capítulo 5: ' . $th->getMessage());
