...
class EgresosCapitulo5EjercidoForm extends Component
{
    ...
    public function render() 
    {
        try{
            ...
            $this->llenarCuentas();
            return view('livewire.egresos-capitulo5-ejercido-form', ['eventos' => $eventos]);
        }catch(\Throwable $th){
            Log::error('Ocurrió un error al cargar eventos en ejercido del capítulo 5: ' . $th->getMessage());
    ...
    public function llenarCamposEspecificos(){
        try{      
            ...
            Log::error('Ocurrió un error al llenar campos específicos en Ejercido del capítulo 5: ' . $th->getMessage());
            $this->dispatch('mostrarMensaje', mensaje: 'Ocurrió un error al cargar el evento, contacte al área de Gobierno Electrónico', tipo: 'error', tiempo: 3000);
        }
    }
    ...
    public function llenarCuentas()
    {
        try{
            ...
            Log::error('Ocurrió un error al llenar las cuentas en Ejercido del capítulo 5000: ' . $th->getMessage());
            $this->dispatch('mostrarMensaje', mensaje: 'Ocurrió un error al cargar el evento, contacte al área de Gobierno Electrónico', tipo: 'error', tiempo: 3000);
        }
    }
    ...
    public function cargarPresupuestoDevengado()
    {
        try{
            ...
            $solvencia = DB::select('EXEC SolvenciaDevengadosCapitulo5 @area = ?, @cuenta = ?, @anio = ?, @mes = ?, @evento = ?', array($departamento->Codigo_completo, $interaccionCuentaCuenta->Codigo_cuenta, $anioActual, $this->mes, $this->numeroEvento))[0]->Total;
            ...
            Log::error('Ocurrió un error al cargar presupuesto en ejercido del capítulo 5: ' . $th->getMessage());
    ...
    public function agregarRegistro()
    {
        try{
            ...
            Log::error('Ocurrió un error al agregar registro en ejercido del capítulo 5: ' . $th->getMessage());
