...
class EgresosCapitulo5PagadoTable extends Tabla
{
    ...
    {
        return view('livewire.egresos-capitulo5-pagado-table');
    }
    ...
    public function agregarRegistro($registro)
    {
        ...
        try {
            ...
            Log::error('Ocurrió un error al agregar registro en pagado del capítulo 5000: ' . $th->getMessage());
    ...
    public function finalizarRegistros()
    {
        ...
        try {
            ...
            $bitacora->bitacora('finalizarRegistros', 'registro o intentó registrar un pagado del capítulo 5 con evento: ' . $this->numeroEvento, request());
            DB::beginTransaction();
            ...
            DB::rollBack();
            Log::error('Ocurrió un error al finalizarRegistro en pagado del capítulo 5: ' . $th->getMessage());
