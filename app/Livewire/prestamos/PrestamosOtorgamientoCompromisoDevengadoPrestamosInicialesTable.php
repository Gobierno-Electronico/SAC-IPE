...
class PrestamosOtorgamientoCompromisoDevengadoPrestamosInicialesTable extends Tabla
{
    ...
    public function finalizarRegistros()
    {
        ...
        try{
            ...
            $bitacora->bitacora('finalizarRegistros', 'registro o intentó registrar un compromiso-devengado préstamos inicales del capítulo 7000: '.$this->numeroEvento, request());
            DB::beginTransaction();
