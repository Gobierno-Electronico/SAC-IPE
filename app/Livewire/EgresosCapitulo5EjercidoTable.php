...
class EgresosCapitulo5EjercidoTable extends Tabla
{
    ...
    public function edit($id)
    {
        try {
            ...
            Log::error('Ocurrió un error al editar en ejercido del capitulo 5: ' . $th->getMessage());
    ...
    public function delete($id)
    {
        try {
            ...
            Log::error('Ocurrió un error al eliminar en ejercido del capítulo 5: ' . $th->getMessage());
    ...
    public function finalizarRegistros()
    {
        ...
        try {
            ...
            $bitacora->bitacora('finalizarRegistros', 'registro o intentó registrar un ejercido del capítulo 5 con evento: ' . $this->numeroEvento, request());
            DB::beginTransaction();
