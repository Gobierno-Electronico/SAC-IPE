...
class PrestamosOtorgamientoCompromisoDevengadoPrestamosRenovacionForm extends Component
{
    ...
    public function render()
    {
        try{
            ...
            return view('livewire.prestamos-otorgamiento-compromiso-devengado-prestamosRenovacion-form', ['cuentas' => $cuentas]);
    ...
    public function cargarPresupuesto()
    {
        try{
            ...
            Log::error('Ocurrió un error al cargar presupuesto en compromiso-devengado préstamos renovación del capítulo 7000: ' . $th->getMessage());
    ...
    public function cargarCuentaContableAbono($bandera)
    {
        ...
        try{
            ...
            Log::error('Ocurrió un error al cargar cuenta contable abono en compromiso-devengado préstamos renovación del capítulo 7000: ' . $th->getMessage());
            $this->dispatch('mostrarMensaje', mensaje: 'Ocurrió un error al cargar presupuesto, contacte al área de Gobierno Electrónico', tipo: 'error', tiempo: 3000);
        }
    }
