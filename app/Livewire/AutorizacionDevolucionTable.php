...
class AutorizacionDevolucionTable extends Tabla
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('devengado', 'PPTO devengado')->component('columns.importe'),
            Column::make('importe', 'Importe')->component('columns.importe'),
            Column::make('nuevoImporte', 'Nuevo importe')->component('columns.importe'),
    ...
    public function finalizarRegistros()
    {
        ...
        try {
            ...
            $bitacora->bitacora('finalizarRegistros', 'registro o intentó registrar una autorización de devolución con evento: '.$this->numeroEvento, request());
            ...
            foreach ($this->dataCompleta as $movimiento) {
                ...
                $polizas = [
                    [
                        ...
                        'validado' => false,
                        'categoria' => 'INGRESOS AUTORIZACION DEVOLUCION',
                        'created_at' => $fecha,
                        'updated_at' => $fecha
                    ]
                ];
            ...
            DB::rollBack();
            Log::error('Ocurrió un error al finalizarRegistro en autorización de devolución: '. $th->getMessage());
