...
class EgresosCapitulo1EjercidoTable extends Tabla
{
    public $cacheData = [];
    public $dataCompleta = [];
    public $perPage = 6;
    ...
    {
        return view('livewire.egresos.egresos-capitulo1-ejercido-table');
    }
    ...
    public function finalizarRegistros()
    {
        ...
        try {
            ...
            $polizasInicialesEgresosEjercido = Poliza::where('tipo_poliza', '=', 'E')
                ->where('categoria', '=', 'EGRESOS EJERCIDO CAPITULO 1')
                ->where('evento', '=', $this->numeroEvento)
