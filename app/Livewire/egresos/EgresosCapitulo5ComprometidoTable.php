...
class EgresosCapitulo5ComprometidoTable extends Tabla
{
    ...
    {
        return view('livewire.egresos.egresos-capitulo5-comprometido-table');
    }
    ...
    public function edit($id)
    {
        try{
            ...
            Log::error('Ocurrió un error al editar en comprometido del capítulo 5: '. $th->getMessage());
    ...
    public function delete($id)
    {
        try{
            ...
            Log::error('Ocurrió un error al eliminar en comprometido del capítulo 5: '. $th->getMessage());
            $this->dispatch('mostrarMensaje', mensaje: 'Ocurrió un error al editar, contacte al área de Gobierno Electrónico', tipo: 'error', tiempo: 3000);
        }
    ...
    public function finalizarRegistros()
    {
        ...
        try{
            ...
            DB::rollBack();
            Log::error('Ocurrió un error al finalizarRegistro en comprometido del capítulo 5: '. $th->getMessage());
