...
class EgresosCapitulo1ComprometidoForm extends Component
{
    ...
    public function render()
    {
        try{
            ...
            ->whereIn('interaccion_cuenta_conceptos.concepto_id', [10103])->where('interaccion_cuenta_conceptos.tipo_interaccion', '=', 'Presupuestal - Cargo')
            ->orderBy('cuentas.Descripcion_cuenta')->get();

            return view('livewire.egresos.egresos-capitulo1-comprometido-form', ['cuentas' => $cuentas]);
        }catch(\Throwable $th){
