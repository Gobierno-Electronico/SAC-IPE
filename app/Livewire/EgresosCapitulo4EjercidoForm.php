...
class EgresosCapitulo4EjercidoForm extends Component
{
    ...
    public function render() 
    {
        try{
            ...
            return view('livewire.egresos-capitulo4-ejercido-form', ['eventos' => $eventos]);
        }catch(\Throwable $th){
    ...
    public function llenarCamposEspecificos(){
        try{      
            ...
            Log::error('Ocurrió un error al llenar campos específicos en Ejercido del capítulo 4: ' . $th->getMessage());
            $this->dispatch('mostrarMensaje', mensaje: 'Ocurrió un error al cargar el evento, contacte al área de Gobierno Electrónico', tipo: 'error', tiempo: 3000);
        }
    }
