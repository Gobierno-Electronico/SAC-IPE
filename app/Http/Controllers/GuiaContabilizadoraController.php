...
class GuiaContabilizadoraController extends Controller
{
    ...
    public function crearGuiaContabilizadora(Request $request)
    {
        ...
        $path = public_path('Guia/Rec-CuentasConceptos-actualizacion-04-03-26.xlsx'); // cambiar el número del capítulo cuando se carguen las relaciones
    ...
    public function relacionarCuentasCuentasSeguidas(Request $request)
    {
        ...
        ini_set('max_execution_time', 30000);
        // return response()->json('Método desactivado');
        $path = public_path('CuentasCuentas/Rec-CuentasCuentasSeguidas-actualizacion-04-03-26.xlsx');
