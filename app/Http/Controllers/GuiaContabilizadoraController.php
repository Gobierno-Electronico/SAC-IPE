...
class GuiaContabilizadoraController extends Controller
{
    ...
    public function crearGuiaContabilizadora(Request $request)
    {
        ...
        $path = public_path('Guia/Ampliaciones-reducciones-ingresos-CuentasConceptos.xlsx'); // cambiar el número del capítulo cuando se carguen las relaciones
    ...
    {
        // return response()->json('Método desactivado');
        $path = public_path('CuentasCuentas/cuentasCuentasPagado1000.xlsx');
    ...
    public function relacionarCuentasCuentasSeguidas(Request $request)
    {
        ...
        ini_set('max_execution_time', 30000);
        // return response()->json('Método desactivado');
        $path = public_path('CuentasCuentas/Ampliaciones-reducciones-ingresos-CuentasCuentasSeguidas.xlsx');
