...
Route::get('/matriz/consultar', [ReportesController::class, 'mostrarVistaConsultaMatriz'])->name('consultarMatriz')->middleware('can:acceso-cuentas');
//Cuentas
...
Route::get('/estado-analitico-del-activo', [ReportesController::class, 'estadoAnaliticoDelActivo'])->name('estadoAnaliticoDelActivo')->middleware('can:acceso-contabilidad-reportes');
